...
# $Id: /local/docs/gettingstarted.pod 13183 2006-07-06T20:05:47.681449Z chip  $
...
need is Perl 5.005_03 or later, a C compiler (any ANSI C compliant compiler
...
L<http://www.nntp.perl.org/group/perl.perl6.announce>

L<http://dev.perl.org/perl6/list-summaries/>

Or if you prefer to subscribe to the list:

L<http://lists.perl.org/showlist.cgi?name=perl6-announce>
...
L<http://www.google.com/search?sourceid=navclient&q=site:archive%2Edevelooper%2Ecom+cvs+parrot>
...
resolve it. To report a bug, email C<bugs-parrot@bugs6.perl.org> with a brief
