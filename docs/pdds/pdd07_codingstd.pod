...
# $Id: /parrotcode/trunk/docs/pdds/pdd07_codingstd.pod 3419 2007-05-08T15:30:57.823298Z particle  $
...
subsystem will be assigned a short nickname, e.g. I<pmc>, I<gc>, I<io>. All code
...
nothing more), i.e. it defines the API. It is permissible for the API to include
...
using tricks such as capitalization, e.g. C<new_foo_bar> rather than C<NewFooBar>
or (gasp) C<newfoobar>.
...
Typedef names should be lower-case except for the first letter, e.g. C<Foo_bar>.
...
going on in the code - e.g. the book you stole the hash function from.
