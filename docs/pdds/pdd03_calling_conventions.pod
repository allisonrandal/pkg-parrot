...
# $Id: pdd03_calling_conventions.pod 10264 2005-11-30 03:07:41Z chip $
...
set to a new .Integer which has been C<assign>ed the given integer.
...
HLL type mapping -- e.g. for HLL "Foo", having an incoming I register map to a
FooInteger.
